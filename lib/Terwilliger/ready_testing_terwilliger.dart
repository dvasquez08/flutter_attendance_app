// Imports for other Terwilliger location pages
...
// This stateful widget manages the check-in process for students who are ready for testing at the Terwilliger location.
      ...
      drawer: Drawer(
        child: ListView(
          ...
          children: [
            ...
            Column(
              children: [
                NavButton("Testing Check-in", testingTerwilliger()), // Using the NavButton component, takes user to the attendance page for testing day
                SizedBox(height: 15.0),
                NavButton("Class Attendance", AttendanceTerwilliger()) // Using the NavButton component, this takes the suer to the main attendance page for this location
              ],
            )
          ],
        ),
