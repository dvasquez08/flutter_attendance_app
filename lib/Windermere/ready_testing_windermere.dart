// Imports for other Windermere location pages
...
Future<void> main() async {
  ...
  runApp(MaterialApp(
      debugShowCheckedModeBanner: false, home: readyTestWindermere()));
}

// This stateful widget manages the check-in process for students who are ready for testing at the Windermere location.
class readyTestWindermere extends StatefulWidget {
  const readyTestWindermere({Key? key}) : super(key: key);

  @override
  State<readyTestWindermere> createState() => _readyTestWindermereState();
}

class _readyTestWindermereState extends State<readyTestWindermere> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Student Ready for Testing Windermere",
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          image: DecorationImage(
              image: AssetImage("assets/testing9.png"), fit: BoxFit.cover),
        ),
      ...
      drawer: Drawer(
        child: ListView(
          ...
          children: [
            ...
            Column(
              children: [
                NavButton("Testing Check-in", testingWindermere()), // Using the NavButton component, takes user to the attendance page for testing day
                SizedBox(height: 15.0),
                NavButton("Class Attendance", attendanceWindermere()) // Using the NavButton component, this takes the suer to the main attendance page for this location
              ],
            )
          ],
        ),
