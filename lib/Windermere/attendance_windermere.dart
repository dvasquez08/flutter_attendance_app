// Imports of other pages for the Windermere location and to the main page
        ...
        child: ListView(
          ...
          children: [
            ...
            Column(
              ...
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                NavButton("Ready for Testing", readyTestWindermere()), // The page to add students to the list that are ready for testing
                SizedBox(height: 15.0),
                NavButton("Testing Check-in", testingWindermere()), // To the attendance page for testing day
                SizedBox(height: 15.0),
